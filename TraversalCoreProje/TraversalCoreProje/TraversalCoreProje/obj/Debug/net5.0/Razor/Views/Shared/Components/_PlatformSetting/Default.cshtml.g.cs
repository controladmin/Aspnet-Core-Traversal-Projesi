#pragma checksum "C:\Users\ali kahya\OneDrive\Masaüstü\C Sharp Projeler\TraversalCoreProje\TraversalCoreProje\TraversalCoreProje\Views\Shared\Components\_PlatformSetting\Default.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "df41be23b2c187e057cc780e6b49671c510fefc2"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"df41be23b2c187e057cc780e6b49671c510fefc2", @"/Views/Shared/Components/_PlatformSetting/Default.cshtml")]
            ...
            <ul class=""list-group"">
                <li class=""list-group-item border-0 px-0"">
                    <div class=""form-check form-switch ps-0"">
                        ...
                        <label class=""form-check-label text-body ms-3 text-truncate w-80 mb-0"" for=""flexSwitchCheckDefault"">İki Adımı Doğrulamayı Aktifleştir</label>
                    </div>
                </li>
                <li class=""list-group-item border-0 px-0"">
                    <div class=""form-check form-switch ps-0"">
            ...
            WriteLiteral(@"ut ms-auto"" type=""checkbox"" id=""flexSwitchCheckDefault3"">
                ...
                <li class=""list-group-item border-0 px-0"">
                    <div class=""form-check form-switch ps-0"">
                        ...
                        <label class=""form-check-label text-body ms-3 text-truncate w-80 mb-0"" for=""flexSwitchCheckDefault4"">Aylık Tur Bülteni Hakkında Mail Bilgilendirmesi Yap</label>
                    </div>
                </li>
                <li class=""list-group-item border-0 px-0 pb-0"">
                    <div class=""form-check form-switch ps-0"">
                        ...
                        ");
            WriteLiteral("<label class=\"form-check-label text-body ms-3 text-truncate w-80 mb-0\" for=\"flexSwitchCheckDefault5\">Youtube\'de Yeni Video Paylaşınca Bildir</label>\r\n                    </div>\r\n                </li>\r\n            </ul>\r\n        </div>\r\n    </div>\r\n</div>");
        }
